...
public class TowerWeapon : MonoBehaviour
{
    ...
    [Header("Cannon")]
    [SerializeField] private GameObject projectilePrefab; //발사체 Prefab
    ...
    public WeaponType WeaponType => weaponType; //무기 속성 정보를 열람하기 위한 Property
    ...
    public void OnBuffAroundTower()
    {
        ...
        for (int i = 0; i < towers.Length; ++i)
        {
            ...
            //이미 버프를 받고 있고, 현재 버프 타워의 레벨보다 높은 버프면 패스
    ...
    public bool Upgrade()
    {
        ...
        //타워가 업그레이드될 때 모든 버프 타워의 버프 효과 갱신
